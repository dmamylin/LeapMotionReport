...
\begin{document}
	...
	\section{Как мы творили темную магию объемного зрения}
		...
		\begin{frame}
			...
			Всегда когда мы работаем со стереоскопией существует необходимость в калибровке: нахождении внешних и внутренних параметров стереопары.
			...
			% Про получение изображений с камер + кратко про stere vision и всякие rectification
		\end{frame}
